...
public class GN_SaveLoad {
	...
	public static SaveData SaveObjectCreator(){
		SaveData CheckSave = new SaveData (SaveData.Instance.FirstTime, SaveData.Instance.isRated, SaveData.Instance.RemoveAds, SaveData.Instance.UnlockLevels, SaveData.Instance.UnlockCars, SaveData.Instance.UnlockEverything, SaveData.Instance.Level, SaveData.Instance.Coins, SaveData.Instance.Cars, SaveData.Instance.IsSoundOn);
		return CheckSave;
	}
